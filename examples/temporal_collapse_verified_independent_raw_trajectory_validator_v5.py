#!/usr/bin/env python3
"""
Temporal Collapse Verified Independent Raw Trajectory Validator — v5
...
v5 applies the same mechanism to trajectories generated by a separate
   independent generator script.
...
INPUT_PATH = DATA_DIR / "temporal_collapse_verified_independent_raw_trajectories_v5.jsonl"
OUTPUT_PATH = RESULTS_DIR / "temporal_collapse_verified_independent_raw_trajectory_validator_v5.json"
...
def main() -> None:
    ...
    payload = {
        "experiment": "temporal_collapse_verified_independent_raw_trajectory_validator_v5",
        "status": "v5_verified_independent_raw_trajectory_validation",
        "boundary": (
            "raw ordered trajectory records generated by a separate generator script; "
            "this is stronger than v4 but does not prove absolute independence"
        ),
        "claim": (
            "This script applies the Level 3 raw trajectory warning mechanism "
            "to raw ordered trajectory records generated by a separate generator "
            "script, using visible signals, weights, thresholds, source labels, "
            "independence method labels, and transition evidence."
        ),
        ...
        "independence_note": (
            "source_independence=generated_by_independent_script means the data "
            "was produced by a separate generator script. This is stronger than "
            "v4 source_independence=not_verified, but it does not prove absolute "
    ...
    print("=" * 100)
    print("TEMPORAL COLLAPSE VERIFIED INDEPENDENT RAW TRAJECTORY VALIDATOR — v5")
    print("=" * 100)
